...
export const sideNavList = [
  ...
  { title: 'Reviews', logo: 'grid_view', options: [{ subTitle: 'My Performance', subLogo: 'checklist', routerLink: MY_PERFORMANCE.fullurl }], isActive: true, },
  { title: 'Refer a Friend', logo: 'groups', options: [
    {
  ...
  { title: 'Training', logo: 'school', options: [
    ...
    {subTitle:"Ongoing Trainings", subLogo:'horizontal_rule',routerLink:ONGOING_TRAININGS.fullurl},
    { subTitle: 'My Trainings', subLogo: 'horizontal_rule',routerLink:MY_TRAINING.fullurl},
  ...
  { title: 'Attendance', logo: 'schedule', options: [{
   ...
   {subTitle:"Punch Log", subLogo:'horizontal_rule',routerLink:PUNCH_LOG.fullurl},
  ], isActive: true, },
  { title: 'Leave', logo: 'calendar_today', options: [{
    subTitle: 'My Leave', subLogo: 'horizontal_rule',routerLink:MY_LEAVE.fullurl},
   {subTitle:"Floating Leave", subLogo:'horizontal_rule',routerLink:FLOATING_LEAVE.fullurl},
   ], isActive: true, },
  { title: 'Tickets', logo: 'view_day', options: [{ subTitle: 'Tickets',routerLink:TICKETS.fullurl ,subLogo: 'horizontal_rule' }], isActive: true, },
  { title: 'DSR', logo: 'calendar_today', options: [{ subTitle: 'My Dsr',routerLink:MY_DSR.fullurl ,subLogo: 'horizontal_rule' }], isActive: true, },
  { title: 'Projects', logo: 'view_day', routerLink:PROJECTS.path ,isActive: true, },
