...
@Component({
  selector: 'app-lunch-calender',
  templateUrl: './lunch-calender.component.html',
  styleUrls: ['./lunch-calender.component.scss'],
})
export class LunchCalenderComponent implements OnInit {
  constructor() {}
